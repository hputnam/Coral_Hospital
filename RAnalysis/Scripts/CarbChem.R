...
mainDir<-'~/MyProjects/Holobiont_Integration/RAnalysis' #set main directory
#############################################################


##### DISCRETE pH CALCULATIONS #####
path <-("~/MyProjects/Holobiont_Integration/RAnalysis/Data/pH_Calibration_Files/")
...
SW.chem2 <- subset(SW.chem, Period1 == "Treatment")
#SW.chem <- subset(SW.chem, Type == "Tank")
SW.chem2$Treatment <- factor(SW.chem2$Treatment)
SW.chem2$Sample.ID <- factor(SW.chem2$Sample.ID)

pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Daily_Treatment_Measures_Treatments.pdf")
par(mfrow=c(3,2))
plot(SW.chem2$Treatment, SW.chem2$Temperature, xlab="Treatment", ylab="Temperature°C", ylim=c(24,31))
plot(SW.chem2$Treatment, SW.chem2$pH.Total, xlab="Treatment", ylab="pH Total Scale", ylim=c(7.0,8.3))
plot(SW.chem2$Treatment, SW.chem2$Salinity, xlab="Treatment", ylab="Salinity psu", ylim=c(31,35))
dev.off()
...
##### Ramp Down
SW.chem3 <- subset(SW.chem, Period1 == "RampDown")
#SW.chem <- subset(SW.chem, Type == "Tank")
SW.chem3$Treatment <- factor(SW.chem3$Treatment)
SW.chem3$Sample.ID <- factor(SW.chem3$Sample.ID)

pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Daily_Treatment_Measures_RampDown.pdf")
par(mfrow=c(3,2))
plot(SW.chem3$Treatment, SW.chem3$Temperature, xlab="Treatment", ylab="Temperature°C", ylim=c(20,31))
plot(SW.chem3$Treatment, SW.chem3$pH.Total, xlab="Treatment", ylab="pH Total Scale", ylim=c(7.0,8.3))
plot(SW.chem3$Treatment, SW.chem3$Salinity, xlab="Treatment", ylab="Salinity psu", ylim=c(31,35))
dev.off()

pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Daily_Tank_Measures_RampDown.pdf")
par(mfrow=c(1,3))
plot(SW.chem3$Sample.ID, SW.chem3$Temperature, xlab="Tank", ylab="Temperature°C", ylim=c(20,31),las=2)
plot(SW.chem3$Sample.ID, SW.chem3$pH.Total, xlab="Tank", ylab="pH Total Scale", ylim=c(7.0,8.3),las=2)
plot(SW.chem3$Sample.ID, SW.chem3$Salinity, xlab="Tank", ylab="Salinity psu", ylim=c(31,36),las=2)
dev.off()

##### Recovery
SW.chem4 <- subset(SW.chem, Period1 == "Recovery")
#SW.chem <- subset(SW.chem, Type == "Tank")
SW.chem4$Treatment <- factor(SW.chem4$Treatment)
SW.chem4$Sample.ID <- factor(SW.chem4$Sample.ID)

pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Daily_Treatment_Measures_Recovery.pdf")
par(mfrow=c(3,2))
plot(SW.chem4$Treatment, SW.chem4$Temperature, xlab="Treatment", ylab="Temperature°C", ylim=c(20,31))
plot(SW.chem4$Treatment, SW.chem4$pH.Total, xlab="Treatment", ylab="pH Total Scale", ylim=c(7.0,8.3))
plot(SW.chem4$Treatment, SW.chem4$Salinity, xlab="Treatment", ylab="Salinity psu", ylim=c(31,35))
dev.off()

pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Daily_Tank_Measures_Recovery.pdf")
par(mfrow=c(1,3))
plot(SW.chem4$Sample.ID, SW.chem4$Temperature, xlab="Tank", ylab="Temperature°C", ylim=c(20,31),las=2)
plot(SW.chem4$Sample.ID, SW.chem4$pH.Total, xlab="Tank", ylab="pH Total Scale", ylim=c(7.0,8.3),las=2)
plot(SW.chem4$Sample.ID, SW.chem4$Salinity, xlab="Tank", ylab="Salinity psu", ylim=c(31,36),las=2)
dev.off()
...
#SW.chem <- subset(SW.chem, TA.Run =="Yes")
#SW.chem <- subset(SW.chem, Period1 =="Treatment")
...
carb.output1 <- subset(carb.output, Period1 == "Acclimation")
carb.output1 <- subset(carb.output1, Treatment == "Acclimation")
carb.output1$Tank <- factor(carb.output1$Tank)

# Need to subset for tanks corals were in
 
pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Acclimation_Water_Chem_withTA.pdf")
par(mfrow=c(3,2))
plot(carb.output1$Tank, carb.output1$Temperature, xlab="Treatment", ylab="Temperature°C", ylim=c(24,29), las=2)
plot(carb.output1$Tank, carb.output1$pH, xlab="Treatment", ylab="pH Total Scale", ylim=c(7.0,8.2), las=2)
plot(carb.output1$Tank, carb.output1$pCO2, xlab="Treatment", ylab="pCO2 µmol kg-1", ylim=c(350,3500), las=2)
plot(carb.output1$Tank, carb.output1$Salinity, xlab="Treatment", ylab="Salinity psu", ylim=c(33,35), las=2)
plot(carb.output1$Tank, carb.output1$TA, xlab="Treatment", ylab="Total Alkalinity µmol kg-1", ylim=c(2100,2250), las=2)
plot(carb.output1$Tank, carb.output1$Aragonite.Sat, xlab="Treatment", ylab="Aragonite Saturation State", ylim=c(0,4), las=2)
dev.off()

carb.output2 <- subset(carb.output, Period1 == "Treatment")
carb.output2$Tank <- factor(carb.output2$Tank)
carb.output2$Treatment <- factor(carb.output2$Treatment)

pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Treatment_Water_Chem_Tanks_withTA.pdf")
par(mfrow=c(3,2))
plot(as.factor(carb.output2$Tank), carb.output2$Temperature, xlab="Tank", ylab="Temperature°C", ylim=c(25,31), las=2)
plot(as.factor(carb.output2$Tank), carb.output2$pH, xlab="Tank", ylab="pH Total Scale", ylim=c(7.4,8.2), las=2)
plot(as.factor(carb.output2$Tank), carb.output2$pCO2, xlab="Tank", ylab="pCO2 µmol kg-1", ylim=c(280,1600), las=2)
plot(as.factor(carb.output2$Tank), carb.output2$Salinity, xlab="Tank", ylab="Salinity psu", ylim=c(32,35), las=2)
plot(as.factor(carb.output2$Tank), carb.output2$TA, xlab="Tank", ylab="Total Alkalinity µmol kg-1", ylim=c(2000,2300), las=2)
plot(as.factor(carb.output2$Tank), carb.output2$Aragonite.Sat, xlab="Tank", ylab="Aragonite Saturation State", ylim=c(0,5), las=2)
dev.off()

pdf("~/MyProjects/Holobiont_Integration/RAnalysis/Output/Treatment_Water_Chem_withTA.pdf")
par(mfrow=c(3,2))
plot(as.factor(carb.output2$Treatment), carb.output2$Temperature, xlab="Tank", ylab="Temperature°C", ylim=c(25,31), las=2)
plot(as.factor(carb.output2$Treatment), carb.output2$pH, xlab="Tank", ylab="pH Total Scale", ylim=c(7.4,8.2), las=2)
plot(as.factor(carb.output2$Treatment), carb.output2$pCO2, xlab="Tank", ylab="pCO2 µmol kg-1", ylim=c(280,2000), las=2)
plot(as.factor(carb.output2$Treatment), carb.output2$Salinity, xlab="Tank", ylab="Salinity psu", ylim=c(32,35), las=2)
plot(as.factor(carb.output2$Treatment), carb.output2$TA, xlab="Tank", ylab="Total Alkalinity µmol kg-1", ylim=c(2000,2300), las=2)
plot(as.factor(carb.output2$Treatment), carb.output2$Aragonite.Sat, xlab="Tank", ylab="Aragonite Saturation State", ylim=c(0,5), las=2)
dev.off()
